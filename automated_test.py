...
apiKey='ek3mftqc47v0i9dli46esi6324'
...
contextIncludeURL = ['http://localhost:8080.*']
...
#              'Submission Form URL=http://localhost:8080/#/logins'
#              'Username field=username&'
#              'Password field=password&'
#              'Target URL=http://localhost:8080/#/logins')
...
authParams = ('hostname=http://localhost&'
              'realm=YWRtaW5AbG9jYWw6RTJ3NFNRaVoh&'
              'port=8080')
...
indicatorRegex = '\QLocation: http://localhost:8080/#/applications\E'
...
userList = [
    {'name': 'admin', 'credentials': 'Username=admin&Password=E2w4SQiZ!'}
]
...
# List can be empty
applicationURL = ['http://localhost:8080/#/applications',
                  'http://localhost:8080/#/',
                  'http://localhost:8080/#/']
